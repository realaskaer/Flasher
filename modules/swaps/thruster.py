...
from modules import DEX, Logger, Aggregator
...
class Thruster(DEX, Logger, Aggregator):
    ...
    async def get_min_amount_out(self, amount_in_wei, tokenIn, tokenOut):
        ...
        params = {
         ...
         'tokenIn': tokenIn.lower(),
         'tokenOut': tokenOut.lower(),
         'type': 'EXACT_INPUT',
