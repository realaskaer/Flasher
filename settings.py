...
WALLETS_TO_WORK = 2           # Аккаунты к запуску. Примеры: 0 / 3 / 3, 20 / [3, 20]
...
GAS_PRICE_MULTIPLIER = 2.5      # Множитель цены газа для транзакций. Ускоряет выполнение или уменьшает цену транзакции
